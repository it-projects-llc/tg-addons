...
class Affiliate(models.Model):
    ...
    def _default_sequence_id(self):
        sequence = self.env.ref("website_sale_affiliate.request_sequence", raise_if_not_found=False)
        if not sequence:
            # Fallback or raise an error if sequence is missing
            raise UserError(
                _("The sequence 'website_sale_affiliate.request_sequence' is not found. Please ensure it is defined."))
        return sequence.id
